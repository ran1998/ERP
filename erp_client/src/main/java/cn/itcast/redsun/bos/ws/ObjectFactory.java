...
package cn.itcast.redsun.bos.ws;
 ...
 * generated in the cn.itcast.redsun.bos.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddWaybill_QNAME = new QName("http://ws.bos.redsun.itcast.cn/", "addWaybill");
    private final static QName _AddWaybillResponse_QNAME = new QName("http://ws.bos.redsun.itcast.cn/", "addWaybillResponse");
    private final static QName _WaybilldetailList_QNAME = new QName("http://ws.bos.redsun.itcast.cn/", "waybilldetailList");
    private final static QName _WaybilldetailListResponse_QNAME = new QName("http://ws.bos.redsun.itcast.cn/", "waybilldetailListResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.itcast.redsun.bos.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.itcast.cn/", name = "addWaybill")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.itcast.cn/", name = "addWaybillResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.itcast.cn/", name = "waybilldetailList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.itcast.cn/", name = "waybilldetailListResponse")
