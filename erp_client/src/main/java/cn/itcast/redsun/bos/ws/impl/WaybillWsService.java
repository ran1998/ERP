 ...
 * 
 */
@WebServiceClient(name = "WaybillWsService", targetNamespace = "http://impl.ws.bos.redsun.itcast.cn/", wsdlLocation = "http://localhost:9090/redsun/ws/waybill?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WAYBILLWSSERVICE_QNAME = new QName("http://impl.ws.bos.redsun.itcast.cn/", "WaybillWsService");
    ...
    public IWaybillWs getWaybillWsPort() {
        return super.getPort(new QName("http://impl.ws.bos.redsun.itcast.cn/", "WaybillWsPort"), IWaybillWs.class);
    }
    ...
    public IWaybillWs getWaybillWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.ws.bos.redsun.itcast.cn/", "WaybillWsPort"), IWaybillWs.class, features);
    }
